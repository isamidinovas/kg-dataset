...
AUTO_PROMPT = (
    ...
    "**Важно:** все вопросы и ответы должны быть написаны **строго на кыргызском языке**.\n\n"
    ...
    "- Вопросы должны быть чёткими и развернутыми, охватывать различные аспекты: тарых, инсандар, маданият, каада-салттар ж.б.\n"
...
def main():
    file_path = "data/Кыргызстандын эң байыркы мезгилдерден XIX кылымдын соңуна чейинки тарыхы(okuma.kg)_Тарых жана коомдук илимдер15.txt"
    output_file = "kyrgyz_dataset11.xlsx"
...
# коррект но ограничения в символах нету